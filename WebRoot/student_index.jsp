...
<div class="leftnav">
  ...
  <h2><span class="icon-user"></span>晚归管理</h2>
  <ul style="display:block">
    <li><a href="servlet/lateReturnServlet?type=liststudent" target="right"><span class="icon-caret-right"></span>个人晚归信息查询</a></li>
    <li><a href="servlet/studentServlet?type=listpersonal" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
