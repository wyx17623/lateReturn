...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="servlet/lateReturnServlet?type=listteacher" target="right"><span class="icon-caret-right"></span>晚归管理</a></li>
    <li><a href="servlet/teacherServlet?type=listpersonal" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
