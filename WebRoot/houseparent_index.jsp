...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="servlet/lateReturnServlet?type=list" target="right"><span class="icon-caret-right"></span>晚归管理</a></li>
    <li><a href="servlet/houseparentServlet?type=listpersonal" target="right"><span class="icon-caret-right"></span>个人信息修改</a></li> 
  </ul> 
