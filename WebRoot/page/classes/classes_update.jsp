...
<%@ page language="java" import="com.gxuwz.bean.BO.actionclass" %>
...
listclasses tl = sl.get(Integer.parseInt(index));
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="servlet/classServlet?type=update">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getClassID() %>" name="classID"  readonly="readonly"  />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
