...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 个人列表</strong> </div>
         ...
         <th>操作</th>
			...
			<tr>
				...
				<div class="button-group">
				 <a class="button border-main" href="<%=path%>/page/userpersonal/houseparentpersonal_update.jsp?houseparentID=<%=houseparentID%>"><span class="icon-edit"></span> 修改</a> </div>
				</td>
			</tr>
	<%} %>
    </table>
