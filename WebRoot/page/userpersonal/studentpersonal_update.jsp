...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="servlet/studentServlet?type=updatepersonal">  
     ...
     <div class="form-group">
      ...
      <%} %>
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=tl.getBedID() %>" name="bedID" data-validate="required:数据必填项" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
